...
function DataGridPagination(props: DataGridPaginationProps) {
  ...
  return (
    <div
      ...
      className={cn(
        'flex flex-wrap flex-col sm:flex-row justify-between items-center gap-2.5 py-0 grow',
        mergedProps?.className,
      )}
    >
      <div className="flex flex-wrap items-center space-x-2.5 pb-0 order-2 sm:order-1">
        {isLoading ? (
      ...
      <div className="flex flex-col sm:flex-row justify-center sm:justify-end items-center gap-2.5 pt-0 order-1 sm:order-2">
        {isLoading ? (
