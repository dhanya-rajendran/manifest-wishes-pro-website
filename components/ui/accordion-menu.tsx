...
function AccordionMenuItem({
  ...
  const { classNames, selectedValue, onItemClick } = React.useContext(AccordionMenuContext);
  return (
    <AccordionPrimitive.Item className="flex" {...props}>
      <AccordionPrimitive.Header className="flex w-full">
        <AccordionPrimitive.Trigger
          ...
          data-selected={selectedValue === props.value ? 'true' : undefined}
        >
          {children}
        </AccordionPrimitive.Trigger>
...
function AccordionMenuSubTrigger({
  ...
  children,
  value,
}: React.ComponentPropsWithoutRef<typeof AccordionPrimitive.Trigger> & { value?: string }) {
  const { classNames, selectedValue, matchPath } = React.useContext(AccordionMenuContext);
  return (
    <AccordionPrimitive.Header className="flex">
      <AccordionPrimitive.Trigger
        ...
        data-selected={value && (matchPath(value) || selectedValue === value) ? 'true' : undefined}
      >
        <>
          {children}
          <ChevronDown
